---
layout: post
title:  "Multimodal Environmental Sensing: Low-cost Sensors, Health Wearables, and Computer Vision"
members: [ASadeghi, SMuhammad, JGavieta, DKustra, PChandra, AThuppilikkat, SShinde, CEkmekcioglu]
...
- Sensor Design: Building IoT-based hardware for vehicle-mounted environmental sensing
- Software Development: Implementing data collection, storage, and visualization tools across health, environmental, and video data streams
- Human-Centered: Conducting real-world user studies with outdoor working drivers and/or riders
- Multimodal Analysis: Extracting traffic-related features from dashcam footage, and correlating with environmental exposure and physiological health data

2. Core competencies required are:
- Programming in Python, Go
- Software engineering and management of data pipelines, database design, cloud-based deployments
...
>
> **This is not a recruitment page.** No enrollment, sign-up, or consent to participate happens here. Participants are recruited and consented separately under the Study's approved REB protocol, and nobody can join the Study through this site. Nothing here creates a participation agreement.
>
...
**Anonymized at collection:** all data is recorded under a study-assigned ID, never the Participant's name.

**Enrollment:** the Study has enrolled on a rolling basis since June 2026.

**Privacy Policy:** [read here](#privacy-policy)

**Terms of Service:** [read here](#terms-of-service)
...
| Category | Covers |
|---|---|
| Settings | Google Health settings |
| Activity and fitness | Steps, workouts, activity levels |
| Health metrics and measurements | General health metrics |
| Exercise GPS location | Location during exercise |
| Nutrition | Logged nutrition data |
| Sleep | Sleep stages, duration, quality |
| Reproductive health | Reproductive health data |
| Logged symptoms | Symptoms manually logged |
| Mindfulness | Mindfulness sessions |
| Profile | Google Health profile |
| Irregular Rhythm Notifications (IRN) | Irregular heart rhythm alerts |
| ECG | Electrocardiogram data |

Several categories above are sensitive or restricted under Google's classification. We request them only where needed for the Study, with the Participant's specific consent; a Participant may decline individual scopes where feasible.

**Air quality sensor data:** particulate matter, temperature, humidity, gas.
...
- Used only to provide/improve the Study, per the Participant's consent — never for advertising.
- Never sold or transferred to data brokers.
...
- Identifiable data (i.e., while the ID-to-identity mapping exists): retained while the Participant remains enrolled in the Study.
...
Questions: sensailabs.research@gmail.com